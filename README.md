...
2. [內容](#2-內容)
3. [安裝與引入模組](#3-安裝與引入模組)
4. [使用 pandas 讀取 CSV 文件](#4-使用-pandas-讀取-csv-文件)
5. [檢查數據類型和缺失值](#5-檢查數據類型和缺失值)
6. [數據編碼](#6-數據編碼)
7. [確認型態](#7-確認型態)
8. [欄位的中文說明](#8-欄位的中文說明)
9. [繪製直方圖(list1欄位)](#9-繪製直方圖(list1欄位))
10. [繪製箱型圖(list3原數字欄位)](#10-繪製箱型圖(list3原數字欄位))
11. [計算相關係數矩陣並繪製熱圖](#11-計算相關係數矩陣並繪製熱圖)
12. [列出相關係數](#12-列出相關係數)
13. [隨機森林](#13-隨機森林)
14. [過採樣](#14-過採樣)
15. [結論](#15-結論)
